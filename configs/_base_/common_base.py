...
INPUT = dict(
    ...
    BG_IMGS_ROOT="",  # "datasets/coco/train2017/" | "datasets/SUN_RGBD/SUNRGBD"
    NUM_BG_IMGS=10000,
...
DATALOADER = dict(
    ...
    MAX_OBJS_TRAIN=1000,  # max number of objs per batch (used when load image-wise data and then flatten then batch)
