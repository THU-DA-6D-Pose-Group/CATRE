...
from core.catre.datasets.dataset_factory import register_datasets_in_cfg
from core.catre.engine.engine import do_test, do_train, do_save_results
from core.catre.models import (
    CATRE_disR_shared,
)
...
def main(args):
    ...
    logger.info(f"Used CATRE module name: {cfg.MODEL.CATRE.NAME}")
    model, optimizer = eval(cfg.MODEL.CATRE.NAME).build_model_optimizer(cfg, is_test=args.eval_only)
    logger.info("Model:\n{}".format(model))
